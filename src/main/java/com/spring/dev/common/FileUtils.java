...
public List<Map<String, Object>> parseInsertFileInfo(IntrGal intrGal, 
		MultipartHttpServletRequest mpRequest) throws Exception{	
	return parseInsertFileInfo(intrGal, null, null, mpRequest);
}
	public List<Map<String, Object>> parseInsertFileInfo(IntrGal intrGal, String tblCd, String tblNm,
			MultipartHttpServletRequest mpRequest) throws Exception{
		/*
			Iterator은 데이터들의 집합체? 에서 컬렉션으로부터 정보를 얻어올 수 있는 인터페이스입니다.
			List나 배열은 순차적으로 데이터의 접근이 가능하지만, Map등의 클래스들은 순차적으로 접근할 수가 없습니다.
