...
function fn_insert(){
    ...
    form.action = "<c:url value='/auth/insert'/>";
    form.submit();
}
</script>
...
<div id="contentarea" class="l-content">
	<div class="breadcrumb">
		<a href="${pageContext.request.contextPath}/main"><span class="path_home">Home</span></a><a href="${pageContext.request.contextPath}/auth/list"><span>게시판관리</span></a><span>게시물관리</span><span class="path_current">${boardManage.boardName}</span>
	</div> <!-- //breadcrumb -->
		...
		<div class="subcontent_inner">
			<div class="subcontent">
				...
				<div class="subcontent_title_wrap">
					<h3 class="subcontent_title">권한관리</h3>
						...
						<table cellspacing="0" class="boardType01_tbl">
							...
							<tbody>
								<tr> 
									...
									<td>
										<div class="input_adj">
											<input type="text" name="authCd" id="authCd" class="input_textN" style="width:200px;" maxlength="5" value="" />
										</div>
									</td>
								</tr>
								<tr> 
									...
									<td>
										<div class="input_adj">
											<input type="text" name="authNm" id="authNm" class="input_textN" style="width:200px;" maxlength="50" value="" />
										</div>
									</td>
								</tr>
								<tr> 
